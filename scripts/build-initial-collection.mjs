...
const collection = { id: collectionId, name: collectionName, code: collectionCode, createdAt: generatedAt, updatedAt: generatedAt };
const manifest = {
  ...
  collections: [{ id: collectionId, name: collectionName, code: collectionCode, path: `collections/${collectionId}/collection.json` }],
};
