...
export const TYPE_META: Record<GameType, TypeMeta> = {
  ...
  Água: { color: '#116C9F', deep: '#063D67', light: '#3F9BC4', symbol: '≋', icon: 'Tipos/agua.png' },
  ...
  Gelo: { color: '#00DDEB', deep: '#007F91', light: '#86F7FA', symbol: '✣', icon: 'Tipos/gelo.png' },
  ...
  Voador: { color: '#E4F1F7', deep: '#8DAEBD', light: '#FBFEFF', symbol: '⌁', icon: 'Tipos/voador.png' },
  Psíquico: { color: '#8439B5', deep: '#4D216F', light: '#BD78E1', symbol: '◉', icon: 'Tipos/psiquico.png' },
  Sombrio: { color: '#111A27', deep: '#030914', light: '#293A50', symbol: '☾', icon: 'Tipos/sombrio.png' },
